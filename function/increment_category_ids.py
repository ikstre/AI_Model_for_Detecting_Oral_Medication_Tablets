...
def main():
    """메인 함수"""
    input_file = 'E:\download\global_category_index(aug_comb_whole,refined)\global_category_index.json'
    output_file = 'E:\download\global_category_index(aug_comb_whole,refined)\global_category_index_updated.json'
